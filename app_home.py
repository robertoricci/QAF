...
def home():
    ...
    st.markdown("<h2 style='text-align: center; color: rgb(74, 113, 152);'> Portal de Análises Quant financeira</h2>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: center; color: rgb(74, 113, 152);'>Portal onde você poderá simular e análizar diversos ativos.</h3>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: center; color: rgb(74, 113, 152);'>Funcionalidade do Portal:</h3>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: center; color: rgb(74, 113, 152)'>ATENÇÃO - Análises feitas através de APIs públicas e não são recomendações de venda/compra de ativos</h4>", unsafe_allow_html=True)
    st.markdown("***")
