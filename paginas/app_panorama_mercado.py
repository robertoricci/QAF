...
def main():
    st.title(":blue[Cotações pelo Mundo] :sunglasses:")
    ...
    with st.container():
        st.write('-----')
        st.subheader("Data  " + date.today().strftime('%d/%m/%Y'))
        
        st.write(
            "Dados extraidos do com delay de 15 minutos [Yahoo Finanças](https://br.financas.yahoo.com/)  Fechamento do dia anterior comparado com cotação atual.")
        ...
        colunas = [col1, col2, col3] = st.columns(3)
